...
# So what you'd want is something that creates a list of all possible sums you can make from that list
# and then a check on that second list to see if the value exists.
